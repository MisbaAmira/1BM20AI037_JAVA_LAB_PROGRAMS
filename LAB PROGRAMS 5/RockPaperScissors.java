...
public class RockPaperScissors 
{
  ...
  private enum Move 
  {
    ...
    public void startGame() 
    {
        ...
        switch (compareMoves) 
        {
          case 0: System.out.println("Tie!"); //Tie
                  break;
          case 1: System.out.println(userMove + " beats " + computerMove + ". You won!"); // User wins
                  userScore++;
                  break;
         case -1: System.out.println(computerMove + " beats " + userMove + ". You lost.");// Computer wins
                  computerScore++;
                  break;
        }
        numberOfGames++;
